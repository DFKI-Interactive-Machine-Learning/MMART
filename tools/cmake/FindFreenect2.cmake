...
FIND_PATH(FREENECT_INCLUDE_DIR libfreenect2.hpp
  /usr/local/include
  /usr/local/include/libfreenect2
)

FIND_LIBRARY(FREENECT_freenect_LIBRARY freenect2
  /usr/local/lib
)
...
IF(FREENECT_INCLUDE_DIR)
	SET(FREENECT_INCLUDE_DIRS ${FREENECT_INCLUDE_DIR} ${FREENECT_INCLUDE_DIR}/tinythread)
